...
public class USDTFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadData() {
        ...
        mService.getMarketList("USDT").enqueue(new Callback<List<MarketItem>>() {
            @Override
